...
{
	[InitializeOnLoad]
	public class StratusTagColorsEditorWindow : EditorWindow
	{
		/// <summary>
		...
		static void Open()
		{
			EditorWindow.GetWindow(typeof(StratusTagColorsEditorWindow), true, "Tag Colors");
		}

		static StratusTagColorsEditorWindow()
		{
